...
export const isMediaPath = media => reMediaPath.test(media.toLowerCase());
export const isImagePath = media => reImagePath.test(media.toLowerCase());
export const isDocPath = media => reDocPath.test(media.toLowerCase());