...
export declare function append(target: NodeEx, node: NodeEx): void;
export declare function insert(target: NodeEx, node: NodeEx, anchor?: NodeEx): void;
...
export declare function claim_html_tag(nodes: any): HtmlTag;
